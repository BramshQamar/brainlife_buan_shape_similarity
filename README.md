...
This is a Brainlife App for for calculating BUAN shape similarity between two given bundles.

## App Description

 This App finds shape similarity between input bundles of same type. This app implements bundle shape similarity method presented in Bundle analytics, a computational framework for investigating the shapes and profiles of brain pathways across populations paper [1].
...
`singularity exec -e docker://brainlife/dipy:1.1.1 brainlife_buan_shape_similarity [your_args]`
